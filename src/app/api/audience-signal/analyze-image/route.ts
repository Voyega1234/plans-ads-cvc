...
const MOCK_RESULT = {
  keywords: [
    'สินค้าแบรนด์เนม', 'ของแต่งบ้าน', 'แฟชั่นไลฟ์สไตล์', 'ราคาดี', 'สั่งออนไลน์',
    'คุณภาพพรีเมียม', 'ดีไซน์สวย', 'ส่งฟรี', 'ของขวัญ', 'ไลฟ์สไตล์',
    'สินค้าใหม่', 'ยอดนิยม', 'ขายดี', 'รีวิวดี', 'best quality',
    'home decor', 'trendy', 'premium product', 'affordable', 'fast delivery',
  ],
  themes: [
    'สินค้าคุณภาพสูง', 'ดีไซน์ทันสมัย', 'ราคาคุ้มค่า',
    'ประสบการณ์ผู้ใช้ดี', 'น่าเชื่อถือ', 'ส่งฟรีทั่วไทย',
    'มีรับประกัน', 'เลือกซื้อออนไลน์', 'lifestyle product',
  ],
  inMarket: [
