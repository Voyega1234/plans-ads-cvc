...
import { Search, Zap, Activity, ShoppingBag, BarChart2, ChevronRight, Ban, PenLine } from 'lucide-react'
...
const tools = [
  ...
  {
    href: '/tools/text-ads-generator',
    icon: PenLine,
    label: 'Text Ads Generator',
    desc: 'เขียน Text Ads ใหม่ด้วย AI — ใส่ suggestion แนบครีเอทีฟ preview แบบ Google, export ส่งลูกค้า และ push เข้าแคมเปญ',
