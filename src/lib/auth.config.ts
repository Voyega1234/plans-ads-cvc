...
// Edge-safe NextAuth config — imported by middleware.ts, so it MUST NOT import
// prisma or any Node-only module (that is what made the old Prisma adapter hang
// sign-in: DB code ended up in the Edge bundle). DB work lives only in auth.ts.
